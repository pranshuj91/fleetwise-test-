...
const PrivateRoute = ({ children }) => {
  ...
  // TODO: Lovable will implement real authentication here
  // For now, bypass auth check - auto-login is handled in AuthContext
  if (loading) {
    return (
  ...
  // Always allow access - auth is bypassed for frontend-only mode
  return children;
};
