...
const ShopOperations = () => {
  ...
  const fetchTimeEntries = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/time-tracking/my-entries`,
        {
  ...
  const fetchEquipment = async () => {
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/equipment/my-checkouts`,
        {
          headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` }
        }
      );
  ...
  const startTimer = async (taskId) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/time-tracking/start`,
        {
          method: 'POST',
          headers: {
  ...
  const stopTimer = async (entryId) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/time-tracking/stop/${entryId}`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
  ...
  const checkoutEquipment = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/equipment/checkout`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const returnEquipment = async (checkoutId) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/equipment/return/${checkoutId}`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
