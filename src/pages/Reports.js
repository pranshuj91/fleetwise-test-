    ...
    try {
      ...
      invoices.forEach(inv => {
        if (inv.customer_name) {
          customerRevenue[inv.customer_name] = (customerRevenue[inv.customer_name] || 0) + inv.total_amount;
        }
      });
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#124481]">{stats.totalWorkOrders}</p>
                </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#1E7083]">${stats.avgRepairCost.toFixed(0)}</p>
                </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#289790]">{stats.completionRate.toFixed(0)}%</p>
                </div>
                ...
                {stats.revenueByMonth.map((item, index) => (
                  <div key={index} className="space-y-1">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-gray-600">${item.revenue.toFixed(0)}</span>
                    </div>
          ...
          <Card className="cursor-pointer hover:shadow-xl transition-shadow" onClick={() => navigate('/reports/fleet-health')}>
            ...
            <CardContent>
              <div className="text-center py-6">
                <p className="text-4xl font-bold text-[#289790] mb-2">{stats.totalTrucks}</p>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">${customer.revenue.toFixed(0)} total revenue</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="text-lg font-bold text-green-600">${customer.revenue.toFixed(0)}</p>
                    </div>
                  </div>
                ))}
              </div>
